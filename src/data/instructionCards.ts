...
const TIER_VARIANT_CARDS: TacticCard[] = [
  ...
  // — tempo-quickens family —
  {
    id: 'instr-tempo-quickens-silver',
    slot: 'instruction',
    name: 'Tempo Quickens',
    description: 'Speed of thought, not just speed of foot. They cannot live with this rhythm.',
    tier: 'silver',
    atkMod: 0,
    defMod: 0,
    effect: { atkMod: 3, defMod: 0, formMod: 0 },
    schools: ['gegenpress', 'direct'],
    family: 'tempo-quickens',
  },
  {
    id: 'instr-tempo-quickens-gold',
    slot: 'instruction',
    name: 'Tempo Quickens',
    description: 'A blur of one-touch combinations. The crowd is on its feet from kickoff.',
    tier: 'gold',
    atkMod: 0,
    defMod: 0,
    effect: { atkMod: 4, defMod: 0, formMod: 0 },
    schools: ['gegenpress', 'direct'],
    family: 'tempo-quickens',
  },
  ...
  {
    id: 'instr-hold-the-line-silver',
    slot: 'instruction',
    name: 'Hold The Line',
    description: 'Centre-backs in lockstep. The offside flag earns its keep.',
    tier: 'silver',
    atkMod: 0,
    defMod: 0,
    effect: { atkMod: 0, defMod: 3, formMod: 0 },
    schools: ['catenaccio'],
    family: 'hold-the-line',
  },
  {
    id: 'instr-hold-the-line-gold',
    slot: 'instruction',
    name: 'Hold The Line',
    description: 'An offside trap rehearsed to art. They run forty yards into nothing.',
    tier: 'gold',
    atkMod: 0,
    defMod: 0,
    effect: { atkMod: 1, defMod: 3, formMod: 0 },
    schools: ['catenaccio'],
    family: 'hold-the-line',
  },
  ...
  // — time-wasting family —
  {
    id: 'instr-time-wasting-silver',
    slot: 'instruction',
    name: 'Time Wasting',
    description: 'Substitutions at the corner flag. The clock our twelfth man.',
    tier: 'silver',
    atkMod: 0,
    defMod: 0,
    effect: { atkMod: 0, defMod: 3, formMod: -1 },
  ...
  {
    id: 'instr-time-wasting-gold',
    slot: 'instruction',
    name: 'Time Wasting',
    description: 'Every dead-ball, every throw, every drop of water. Pragmatism, perfected.',
    tier: 'gold',
    atkMod: 0,
    defMod: 0,
    effect: { atkMod: 0, defMod: 4, formMod: 0 },
    schools: ['catenaccio'],
    family: 'time-wasting',
  },

  // — underdog-bite family —
  {
    id: 'instr-underdog-bite-silver',
    slot: 'instruction',
    name: "Underdog's Bite",
    description: 'No pressure, no fear, no respect for reputation.',
    tier: 'silver',
    atkMod: 0,
    defMod: 0,
    effect: {
  ...
  {
    id: 'instr-underdog-bite-gold',
    slot: 'instruction',
    name: "Underdog's Bite",
    description: 'The minnow with the killer instinct. They came expecting nothing — they got plenty.',
    tier: 'gold',
    atkMod: 0,
    defMod: 0,
    effect: {
  ...
  // — away-days family —
  {
    id: 'instr-away-days-silver',
    slot: 'instruction',
    name: 'Away Days',
    description: 'A coach load of believers, drowning out the home stand.',
    tier: 'silver',
    atkMod: 0,
    defMod: 0,
    effect: {
  ...
  {
    id: 'instr-away-days-gold',
    slot: 'instruction',
    name: 'Away Days',
    description: 'The travelling support paints the city in our colours. We respond.',
    tier: 'gold',
    atkMod: 0,
    defMod: 0,
    effect: {
  ...
  {
    id: 'instr-home-comforts-silver',
    slot: 'instruction',
    name: 'Home Comforts',
    description: 'Our turf, our patterns, our roar from the South Stand.',
    tier: 'silver',
    atkMod: 0,
    defMod: 0,
    effect: {
  ...
  {
    id: 'instr-home-comforts-gold',
    slot: 'instruction',
    name: 'Home Comforts',
    description: 'A fortress unbreached. Visitors leave with no shots, no points, no pride.',
    tier: 'gold',
    atkMod: 0,
    defMod: 0,
    effect: {
  ...
  // — cup-tied family —
  {
    id: 'instr-cup-tied-silver',
    slot: 'instruction',
    name: 'Cup Tied',
    description: 'Knockout football, learned in midweek and rehearsed at the weekend.',
    tier: 'silver',
    atkMod: 0,
    defMod: 0,
    effect: {
  ...
  {
    id: 'instr-cup-tied-gold',
    slot: 'instruction',
    name: 'Cup Tied',
    description: 'Replays, extra time, penalties — we welcome them all. Wembley begins here.',
    tier: 'gold',
    atkMod: 0,
    defMod: 0,
    effect: {
  ...
  // — big-game family —
  {
    id: 'instr-big-game-silver',
    slot: 'instruction',
    name: 'Big Game Mentality',
    description: 'No tightening of the shirts when the cameras roll. We rehearse the moment.',
    tier: 'silver',
    atkMod: 0,
    defMod: 0,
    effect: {
  ...
  {
    id: 'instr-big-game-gold',
    slot: 'instruction',
    name: 'Big Game Mentality',
    description: 'Saturday tea-time, packed house, gold standard opposition. Our element.',
    tier: 'gold',
    atkMod: 0,
    defMod: 0,
    effect: {
  ...
  // — bully-pulpit family —
  {
    id: 'instr-bully-pulpit-silver',
    slot: 'instruction',
    name: 'Bully Pulpit',
    description: 'First whistle, first tackle, first goal. Set the tone and never apologise.',
    tier: 'silver',
    atkMod: 0,
    defMod: 0,
    effect: {
  ...
  {
    id: 'instr-bully-pulpit-gold',
    slot: 'instruction',
    name: 'Bully Pulpit',
    description: 'No mercy match. The fixture list giveth, we taketh.',
    tier: 'gold',
    atkMod: 0,
    defMod: 0,
    effect: {
  ...
  // — park-the-bus family —
  {
    id: 'instr-park-the-bus-silver',
    slot: 'instruction',
    name: 'Park The Bus',
    description: "Two banks, a back six if we have to. We don't entertain — we endure.",
    tier: 'silver',
    atkMod: 0,
    defMod: 0,
    effect: {
  ...
  {
    id: 'instr-park-the-bus-gold',
    slot: 'instruction',
    name: 'Park The Bus',
    description: 'A goalless masterclass on the away end. The point feels like three.',
    tier: 'gold',
    atkMod: 0,
    defMod: 0,
    effect: {
